                ...
                <table class="table table-striped">
                  {{--  <tr>
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if (!empty($data->utility_name)){ ?>
                            {{ implode (", ", ( unserialize($data->utility_name))) }}
                            <?php } ?>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class="red">How Deep In gorund</th>
                        <th>{{$data->deep}}</th>
                    </tr>
                    <tr>

                        <th class="red">Line Scan</th>
                        <th>{{$data->line_scan}}</th>
                    </tr>
                    <tr>

                        <th class="red">information</th>
                        <th>
                            @foreach($information as $ter)
                    ...
                    <tr>
                        ...
                        <th class="red">Steel Fiber In Cement</th>
                        <th>{{$data->fiber}}</th>
                    </tr>

                    <tr>

                        <th class="red">Clean And Dirty</th>
                        <th>{{$data->clean}}</th>
                    </tr>
                    <tr>

                        <th class="red">Old IS</th>
                        <th>{{$data->concrete}}</th>
                    </tr>
            ...
            <div class="box-body" style="">
                ...
                <form method="POST" action="{{ route('file.upload') }}" aria-label="{{ __('Upload') }}">
                    ...
                    <div class="form-group row ">
                        <input type="hidden" value="{{$data->id}}" name="gpr_project">
