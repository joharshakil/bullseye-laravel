        ...
        <div class="box">
            <table class="table text-center" id="table">
                ...
                <div class="box-header with-border">
                    PRIVATE ELECTRIC LOCATE SERVICE
                </div>
...
--}}
            ...
            <div class="box-header with-border">
                @if($data->status != 'paid')
                    <form action="/paypal/express-checkout" method="post">
                        {{ Form::token() }}
                        <input type="hidden" name="name" value="pel_service">
        ...
        <div class="box box-widget">
            ...
            <div class="box-footer box-comments" style="">
                @forelse ($pel->comments as $comment)
            ...
            <div class="box-body" style="">
                ...
                <form method="POST" action="{{ route('file.upload') }}" aria-label="{{ __('Upload') }}">
                    ...
                    <div class="form-group row ">
                        <input type="hidden" value="{{$data->id}}" name="pel_project">
