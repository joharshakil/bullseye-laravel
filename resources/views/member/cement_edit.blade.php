        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="/cement_update/{{$data->id}}" method="post" enctype="multipart/form-data" data-parsley-validate="" validate="" class="form-horizontal" data-toggle="validator" >
                    {{ csrf_field() }}
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="date" required="required" class="form-control"  id="date" value="{{$data->delivery_date}}">
                                            </div>
                                            <div class="col-sm-4">
                                                <code>required</code>
                                            </div>
...
{{--
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="item" required="required" class="form-control" value="{{ $data->item }}">
                                            </div>
                                            <div class="col-sm-4">
                                                <code>required</code>
                                            </div>
