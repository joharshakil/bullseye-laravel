...
@section('content')
    ...
    <section id="my-banner">
        ...
        <h1 class="banner-title wow fadeInDownBig">(GPR) Ground Penetrating Radar</h1>
    </section>
    <div class="container">
        ...
        <div class="bootstrap-iso extra-padng">
            <div class="container-fluid">
                ...
                <!-- Modal -->
                <div class="modal fade services-modal-form" id="gprModal" role="dialog"  data-keyboard="false" data-backdrop="static">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1 text-left pricing-content wow fadeInDown">
                        ...
                        <h5><b>(GPR) Ground Penetrating Radar with (EM) is billed $300.00 Per hour with a 2 hour minimum</b>   </h5>
                        ...
                        <ul>
                            ...
                            <li>  Residential homes – (2 Hours)</li>
            ...
            <div class="col-md-10 col-md-offset-1">
                <form method="post" action="{{route('gpr_store')}}" id="gpr_form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label class="control-label " for="text">
                                    <h1 class="larger-service">  (GPR) Ground Penetrating Radar with (EM)</h1>
                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="" name="officePhone"  placeholder="Office Phone" type="number">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    {{--<div class="col-md-6">--}}
                                    <input id="password-confirm" type="password" class="form-control" placeholder="Password" name="password" required>
                                    {{--</div>--}}
                                </div>
                            </div>
                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="us9-street1"  disabled="disabled">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">City:</label>
                                                    <input class="form-control" id="us9-city" disabled="disabled">
                                                </div>
                                            </div>
                                        </div> <!-- End Row -->--}}
                    ...
                    {{--   <div class="row">
                           ...
                           <div class="col-md-6">
                               <div class="form-group">
                                   <label class="control-label">Street:</label>
                                   <input class="form-control" id="us4-street1" name="province" disabled="disabled">
                               </div>
                           </div>
                           <div class="col-md-6">
                               <div class="form-group">
                                   <label class="control-label">City:</label>
                                   <input class="form-control" id="us4-city" name="city" disabled="disabled">
                               </div>
                           </div>
                       </div> <!-- End Row -->--}}
                    ...
                    <div class="row">
                        <h2 class="form-heading text-center">Billing Address</h2>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Street:</label>
                    ...
                    {{--      <div class="form-group">
                              ...
                              <input type="text" name="billinglocation" placeholder="Location" required class="form-control">--}}
...
--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">City:</label>
                                <input class="form-control"  placeholder="City" id="us4-city" name="job_city">
                            </div>
                        </div>
                    </div> <!-- End Row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control"  plcaholder="Postal Code" id="us4-zip" name="job_zipcode">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location" placeholder="Location" id="us4-address" required class="form-control"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nearest Cross Street" name="crossStreet" id="crossStreet" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Job Site Contact Name" name="jobsiteContactNaame"  id="job-siteContactNaame" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Job Site Contact Number:</label>
                                <input class="form-control" placeholder="Job Site Contact Number" type="number" id="jobsiteContactNumber" name="jobsiteContactNumber" >
                            </div>
                        </div>
                    </div> <!-- End Row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <div class="checkbox">
                                    <label class="checkbox">
                                        <input name="report[]" type="checkbox" value="KMZ Report"/>
                                        KMZ Report
                                    </label>
                                </div>
                                <div class="checkbox ">
                                    <label class="checkbox">
                                        <input name="report[]" type="checkbox" value="Depth Slice Report KMZ"/>
                                        Depth Slice Report KMZ
                                    </label>
                                </div>
                                <div class="checkbox ">
                                    <label class="checkbox">
                                ...
                                <div class="checkbox ">
                                    <label class="checkbox">
                                        <input name="report[]" type="checkbox" value="Drill  Locator Report "/>
                                ...
                                <div class="checkbox ">
                                    <label class="checkbox">
                                        <input name="report[]" type="checkbox" id="checkOther2" value="Other"/>
                                        <input type="text" name="report[]" id="addition-info2" style="display:none;">
                                        Other
                                    </label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <div class=" ">
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="surface"/>
                                            surface
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Ground (Dirt)"/>
                                            Ground (Dirt)
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Grass"/>
                                            Grass
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Asphalt"/>
                                            Asphalt
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Ice"/>
                                            Ice
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Cement"/>
                                            Cement
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Flat"/>
                                            Flat
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Hills"/>
                                            Hills
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="flat and hills"/>
                                            flat and hills
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            ...
                                            <input name="terrain[]" type="checkbox" id="checkOther5" value="Other"/>
                                            <input type="text" name="terrain[]" id="addition-info5" style="display:none;">
                                            Other
                                        </label>
                                    </div>
                                </div>
...
--}}
                                    ...
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" value="Well-Electric & water">
                                            Well-Electric & water
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="terrain[]" type="checkbox" id="checkOther1" value="Other"/>
                                            <input type="text" name="terrain[]" id="addition-info1" style="display:none;">
                                            Other
                                        </label>
                                    </div>
                                </div>
                                ...
                                <!--
                                <select class="select form-control" id="select2" name="utility_name">
                                    <option value="Target">
                                        Target
                                    </option>
                                    ...
                                    <option value="Well-Electric &amp; water">
                                        Well-Electric &amp; water
                                    </option>
                                    <option value="Tanks (UST)">
                                        Tanks (UST)
                                    </option>
                                    <option value="Voids">
                                        Voids
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class=" ">
                                    ...
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="utility[]" type="checkbox" id="checkOther4" value="Other"/>
                                            <input type="text" name="utility[]" id="addition-info4" style="display:none;">
                                            Other
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <div class=" ">
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="information[]" type="checkbox"
                                                   value="Locate Utility for excavation"/>
                                            Locate Utility for excavation
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="information[]" type="checkbox" value="Verify depth"/>
                                            Verify depth
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="information[]" type="checkbox" value="Record GPS positions"/>
                                            Record GPS positions
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label class="checkbox">
                                            <input name="information[]" type="checkbox" value="Create depth slices"/>
                                            Create depth slices
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        ...
                                        <label class="checkbox">
                                            <input name="information[]" type="checkbox" id="checkOther3" value="Other"/>
                                            <input type="text" name="information[]" id="addition-info3" style="display:none;">
                                            Other
                                        </label>

                                        {{--  <label class="checkbox">
                                              <input name="information[]" type="checkbox" value="Other"/>
                                              Other
                                          </label>--}}
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <select class="select form-control" id="select9" name="clean">
                                    <option value="Yes">
                                        Yes
                                    </option>
                                    <option value="No">
                    ...
                    {{--   <div class="col-md-6">
                         <div class="form-group ">
                             ...
                             <input type="text" class="select form-control" placeholder="How old is poor or concrete" id="select10" name="concrete">
                    ...
                    <div class="form-group ">
                        <label class="control-label " for="message">
                            Please Describe Ground Conditions
                        </label>
                        <textarea class="form-control" cols="40" id="message" name="condition"
                                  placeholder="Data Entry box" rows="10"></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input class="form-control"  id="date" name="delivery_date" placeholder="MM/DD/YYYY" type="text"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group ">
                    ...
                    <div class="form-group ">
                        <label class="control-label " for="message1">
                            What type of work are you doing &amp; where on property?
                        </label>
                        <textarea class="form-control" cols="40" id="message1" name="about_property"
                                  rows="10"></textarea>
                    </div>
                    <div class="row form-group">
                        <!--    <div class="col-md-1"><input type="checkbox" name="terms" id="terms" required> </div> -->
                        <div class="col-md-12 term-condis"> <p><input type="checkbox" name="terms" id="terms" data-toggle="modal" data-target="#gprModal" required><strong><a href="#" style="cursor: default; pointer-events: none;"> I Agree to the Terms & Conditions</a> </strong> </p></div>
                    </div>
                    ...
                    <div class="form-group">
                        <div>
                            <button class="btn btn-info btn-lg " name="submit" type="submit" id="submit_form">
                                {{--    Submit--}}
                                Register
                            </button>
                ...
                <form action="/paypal/express-checkout" method="post" id="paypal" style="">
                    {{ Form::token() }}
                    <input type="hidden" name="name" value="gpr_service">
    ...
    <script>
        $(document).ready(function(){
            ...
            /*   $('#accept_button').click(function(){
                   if($('#approve').val() == '' && $('#date').val() == '' && $('#name').val() == ''){
                       $('#error').html('please Fill the Fields');
                   }else{
                       $('#gprModal').modal('toggle');
                   }
               });*/
            ...
            $(".checkbox input").click(function(){
                ...
                if ( $(".checkbox #checkOther4").is(':checked') ) {
                    $("#addition-info4").show();
                }
                else{
                    $("#addition-info4").hide();
            ...
            $(".checkbox input").click(function(){
                ...
                if ( $(".checkbox #checkOther6").is(':checked') ) {
                    $("#addition-info6").show();
                }
                else{
                    $("#addition-info6").hide();
            ...
            $(".checkbox input").click(function(){
                ...
                if ( $(".checkbox #checkOtherssss").is(':checked') ) {
                    $("#addition-infosss").show();
                }
                else{
                    $("#addition-infosss").hide();
                }
            })
        })
...
//            $('#paypal').show();
  e.preventDefault();
                ...
                if (check == false) {
                    ...
                    $('#submitting').show();
                    $('#submit_form').hide();
                    var action = $('#gpr_form').attr('action');
                    var register = $('#form_login :input');
                      var url = '';
                    var data = {};
                    var myform = document.getElementById("gpr_form");
